...
struct source_loc
{
	...
	{
		return line_empty() && filename_empty() && funcname_empty();
	}
    SPDLOG_CONSTEXPR bool line_empty() const SPDLOG_NOEXCEPT
    {
		return 0 == line;
    }
	SPDLOG_CONSTEXPR bool filename_empty() const SPDLOG_NOEXCEPT
	{
		return nullptr == filename;
	}
	SPDLOG_CONSTEXPR bool funcname_empty() const SPDLOG_NOEXCEPT
	{
		return nullptr == funcname;
	}
