...
SPDLOG_INLINE std::tm pattern_formatter::get_time_(const details::log_msg &msg)
{
    ...
    {
        return details::os::localtime(static_cast<time_t>(log_clock::to_time_t(msg.time)));
    }
    return details::os::gmtime(static_cast<time_t>(log_clock::to_time_t(msg.time)));
}
